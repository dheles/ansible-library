...
def authorize_key(config, boot_user, user, *key_paths)
  [*key_paths, nil].each do |key_path|
    ...
    if File.exists?(full_key_path)
      config.vm.provision 'file',
        ...
        destination: "/home/#{boot_user}/.ssh/authorized_key.pub"
      ...
      config.vm.provision 'shell',
        ...
        inline:
          ...
          "mv /home/#{boot_user}/.ssh/authorized_key.pub /home/#{user}/.ssh/authorized_keys && " +
          "chown -R #{user}:#{user} /home/#{user}/.ssh && " +
          "chmod 700 /home/#{user}/.ssh && " +
          "chmod 600 /home/#{user}/.ssh/* && " +
          "rm -f /home/#{boot_user}/.ssh/authorized_key.pub && " +
          'echo "Done!"'
      break
    end
  end
